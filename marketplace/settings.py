...
ALLOWED_HOSTS = ['marketplace-dev.us-west-2.elasticbeanstalk.com','127.0.0.1','connectopasal.com','172.31.46.200']
...
INSTALLED_APPS = [
    ...
    'myapps.customer.apps.CustomerConfig',
